    ...
    <div className="profile-full-page">
      ...
      <div className="profile-full-body">
          ...
          {editedName !== null ? (
            <div className="profile-inline-edit">
              ...
              <div className="profile-inline-actions">
                <button className="profile-action-btn" onClick={() => setEditedName(null)}>
                  Cancel
                </button>
                <button className="profile-action-btn save" onClick={changeUserName} disabled={editedName.trim() === authUser.name}>
                  Save
                </button>
              </div>
            </div>
            ...
            <div className="profile-section-content">
              ...
              <button className="profile-edit-btn" onClick={() => setEditedName(authUser?.name || null)}>
                📝
              </button>
            </div>
          )}
          <div className="profile-helper-text">This is not your username or pin. This name will be visible to your contacts.</div>
        </div>
        ...
        <div className="profile-section-card">
          ...
          <div className="profile-section-content">
            <span className="profile-section-value">
              {authUser?.username
                ? authUser.username
                : "@" + authUser.name + authUser.name[0].toLowerCase() + authUser.name[authUser.name.length - 1].toLowerCase() + "_"}
            </span>
          </div>
        </div>
        ...
        <div className="profile-section-card">
          ...
          <div className="profile-section-content">
            <span className="profile-section-value">{authUser.about || "Available"}</span>
        ...
        <div className="profile-section-card">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            <div>
              <div style={{ color: '#69717f', fontSize: '0.9rem', marginBottom: '4px', fontWeight: 600 }}>Email</div>
              <div className="profile-section-value">{authUser.email}</div>
            </div>
            <div>
              <div style={{ color: '#69717f', fontSize: '0.9rem', marginBottom: '4px', fontWeight: 600 }}>Connected via</div>
              <div className="profile-section-value">{authUser.authProvider.charAt(0).toUpperCase() + authUser.authProvider.slice(1)}</div>
            </div>
            <div>
              <div style={{ color: '#69717f', fontSize: '0.9rem', marginBottom: '4px', fontWeight: 600 }}>Member Since</div>
